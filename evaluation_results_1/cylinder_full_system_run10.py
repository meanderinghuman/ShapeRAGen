...
# Ensure mesh is clean and printable
hollow_cylinder = hollow_cylinder.process(validate=True)  # Validate and fix mesh
hollow_cylinder.update_faces(hollow_cylinder.nondegenerate_faces())  # Remove bad geometry
hollow_cylinder.update_faces(hollow_cylinder.unique_faces())  # Clean up duplicates
